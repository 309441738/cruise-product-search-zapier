---
name: cruise-product-search
title: cruise-product-search
description: 通过关键词快速搜索邮轮产品，方便用户快速找到心仪的邮轮。
kind: MCP
version: 0.1.0
...
```json
{ "input": "...", "skill": "cruise-product-search" }
```
